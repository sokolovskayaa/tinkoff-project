...
public class JdbcLinkRepository {
    private static final String SELECT_LINKS_FROM_CHAT_QUERY =
        "SELECT id, url, updated_at FROM link join chat_link on chat_link.link_id = link.id where chat_link.chat_id = ?";
    ...
    private static final String SELECT_CHAT_LINK_BY_ID_AND_URL_QUERY =
        "select chat_id, link_id from chat_link, link where link.url = ? and link.id = link_id and chat_id = ?";
